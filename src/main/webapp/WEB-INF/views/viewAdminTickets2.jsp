...
<script>
	...
	$(document).ready(function() {
	    ...
	    $.ajax({
	        url: 'http://localhost:8485/tickets/getAdminTickets?email=' + encodeURIComponent(userEmail),  
	        method: 'GET',
	        dataType: 'json',
	        success: function(tickets) {
				tickets.forEach(function(ticket) {
			        ...
			        decisionControls += "<label><input type='radio' name='decision_" + ticket.id + "' value='Resolve'> Resolve</label>";
